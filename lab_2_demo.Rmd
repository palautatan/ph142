...
# Resources
I urge you to create a cheatsheet of all the functions you have seen and are responsible for in lecture. Dr. Riddell is very thorough in telling you which ones you need. Those are the only notes you need to really take when it comes to coding.
...
ggplot(iris_subset, aes(x=Sepal.Length, y=Sepal.Width))
...
# Regression
How would you define regression? I'm not going to focus on regression because there are only two functions that she goes over that you need in this portion. This should be an incentive to look over your lecture slides.

In our scatterplot, where do you suspect our line of best fit to appear?

What is the formula for a straight line?

What do you run a regression on: "Y on X" or "X on Y"?
